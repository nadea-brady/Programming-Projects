...
function getNotes($conn, $courseID) {
    $query = 'SELECT n.Note_ID, n.Note_Date, n.Note_Name, n.Note_Path, u.User_Name
              FROM Notes n
              INNER JOIN Users u ON n.Users_User_Id = u.User_Id
              WHERE n.Course_Course_ID = ?
    ...
    foreach ($notes as $note) {
        ...
        echo '<td>' . htmlspecialchars($note['User_Name']) . '</td>'; // Display the username
...
<header class="course-header">
    ...
    <div class="button-container">
        ...
        <div class="view-students-button">
    <form method="GET" action="viewstudentsprofessor.php">
